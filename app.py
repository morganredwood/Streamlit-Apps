...
if st.session_state.mode == "adding":
    ...
    with right_col:
        ...
        with st.form(key="input_form", clear_on_submit=True):
            ...
            with btn_col1:
                submit_task = st.form_submit_button({"color": "lightgreen"}, label="Add Task")

            with btn_col2:
                move_task_click = st.form_submit_button({"color": "lightblue"}, label="Move Task")
                if move_task_click:
            ...
            with btn_col3:
                delete_task_click = st.form_submit_button({"color": "lightcoral"}, label="Delete Task")
